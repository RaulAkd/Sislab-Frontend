...
export class PersonalComponent implements OnInit {
  ...
  // tslint:disable-next-line:max-line-length
  displayedColumnsData = ['id_personal', 'tipoPersonal', 'cargosPersonal', 'cedula_pe', 'nombres_pe', 'direccion_pe', 'telefono_pe', 'email_pe', 'cargo_pe', 'tipo_pe', 'sueldo_pe', 'fechaing_pe', 'fechafin_pe', 'aux_idpersonal', 'id_unidad', 'acciones'];
